...
### Positive Behavior
Examples of behavior that contributes to a positive, collaborative environment include:
*   Demonstrating empathy and kindness toward other people.
*   Being respectful of differing opinions, viewpoints, and experiences.
*   Giving and gracefully accepting constructive, evidence-backed feedback.
*   Accepting responsibility and apologizing to those affected by our mistakes, and learning from the experience.
*   Focusing on what is best for the overall health and safety of the community.
...
*   Other conduct which could reasonably be considered inappropriate in a professional, collaborative setting.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at **security@graphenium.dev**. All complaints will be reviewed and investigated promptly and fairly.
...
Detailed impact guidelines can be found at https://www.contributor-covenant.org/version/2/1/code_of_conduct/code_of_conduct.md.